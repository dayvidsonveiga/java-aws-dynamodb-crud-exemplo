...
import br.com.dynamodb.entity.PlayerHistoryEntity;
...
public class PlayerController {
    ...
    public ResponseEntity<PlayerHistoryEntity> update(@PathVariable("username") String username,
                                                        @PathVariable("gameId") String gameId,
                                                        @RequestBody ScoreDto scoreDto) {
        var entity = dynamoDbTemplate.load(Key.builder()
                .partitionValue(username)
    ...
    public ResponseEntity<PlayerHistoryEntity> delete(@PathVariable("username") String username,
                                                        @PathVariable("gameId") String gameId) {
        var entity = dynamoDbTemplate.load(Key.builder()
                .partitionValue(username)
                .sortValue(gameId)
